...
function Get-TfsBldDef
{
    ...
    #$definitionsOverview = ConvertFrom-Json $JsonResult  #original
    #test
    #https://github.com/MultiPoolMiner/MultiPoolMiner/issues/420
    $JsonParameters = ConvertFrom-Json -InputObject $JsonResult
    #
